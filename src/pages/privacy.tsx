...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;{'Story Oddyssey Safe'}&rdquo; refers to a web-based graphical user interface for Safe Accounts as well
        as a mobile application on Android and iOS.
      </li>
      <li>
    ...
    <h4>4.1. When visiting our website and using {'Story Oddyssey Safe'}</h4>
    <p>
      When visiting our website or using {'Story Oddyssey Safe'}, we may collect and process personal data. The data
      will be stored in different instances
    </p>
    <ol>
      <li>
    ...
    <ol start={4}>
      <li>
        ...
        the {'Story Oddyssey Safe'}, we process your
        <ol>
    ...
    <p>
      4.2.2 For general operational analysis of the {'Story Oddyssey Safe'} interface, monitoring transaction origins
      and measuring transaction failure rates to ensure improved service performance and reliability, we process
      information which constitutes the transaction service database, such as:
    </p>
    <ol>
      <li>signatures</li>
    ...
    <p>
      In addition, we may take a recording of you while testing {'Story Oddyssey Safe'} for internal and external use.
    ...
    <p>
      {'Story Oddyssey Safe'} mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the {'Story Oddyssey Safe'} mobile app via biometrics information (touch ID or face
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with {`Story Oddyssey Safe`}. For
...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>{'Story Oddyssey Safe – Privacy policy'}</title>
      </Head>
