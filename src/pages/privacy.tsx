...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;Story Safe&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a mobile
    ...
    <h4>4.1. When visiting our website and using Story Safe</h4>
    <p>
      When visiting our website or using Story Safe, we may collect and process personal data. The data will be stored
    ...
    <ol start={4}>
      <li>
        ...
        the Story Safe, we process your
        <ol>
    ...
    <p>
      4.2.2 For general operational analysis of the Story Safe interface, monitoring transaction origins and measuring
    ...
    <p>
      In addition, we may take a recording of you while testing Story Safe for internal and external use. The basis for
    ...
    <p>
      Story Safe mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the Story Safe mobile app via biometrics information (touch ID or face ID). This is a
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with Story Safe. For enhanced
...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>Story Safe – Privacy policy</title>
      </Head>
