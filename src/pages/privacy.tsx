...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;Story Oddyssey Safe&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a
    ...
    <p>
      When visiting our website or using Story Oddyssey Safe, we may collect and process personal data. The data will be
    ...
    <ol start={8}>
      <li>
        When we collect relevant&nbsp;data&nbsp;from the Blockchain to display context information in the Story Oddyssey
        Safe we process:
        <ol>
          <li>your public Wallet address, </li>
          <li>account balance,</li>
    ...
    <p>
      4.2.2 For general operational analysis of the Story Oddyssey Safe interface, monitoring transaction origins and
    ...
    <p>
      In addition, we may take a recording of you while testing Story Oddyssey Safe for internal and external use. The
    ...
    <p>
      We enable the user to unlock the Story Oddyssey Safe mobile app via biometrics information (touch ID or face ID).
