...
export const ImportFileUpload = ({
  ...
  return (
    <>
      <Typography>Import Story Oddyssey Safe data by uploading a file in the area below.</Typography>
      ...
      <Typography>
        ...
        />
        Only JSON files exported from the Story Oddyssey Safe can be imported.
      </Typography>
    </>
  )
}
